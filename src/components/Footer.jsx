        ...
        <footer className="footer">
            <div className="footer__container container">
                <div className="footer__about-us">
                    <h5 className="footer__about-us_title">О компании</h5>
                    <ul className="footer__about-us_list">
                        <li className="footer__about-us_list_item"><a href="#" className="footer__about-us_link">Партнёрская программа</a></li>
                        <li className="footer__about-us_list_item"><a href="#" className="footer__about-us_link">Вакансии</a></li>
                    </ul>
                </div>
                <div className="footer__menu">
                    <h5 className="footer__menu_title">Меню</h5>
                    <div className="footer__menu_lists">
                        <ul className="footer__menu_list_left">
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Расчёт стоимости</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Услуги</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Виджеты</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Интеграции</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Наши клиенты</a></li>
                        </ul>
                        <ul className="footer__menu_list_right">
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Кейсы</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Благодарственные письма</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Сертификаты</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Блог на Youtube</a></li>
                            <li className="footer__menu_list_item"><a href="#" className="footer__menu_link">Вопрос / Ответ</a></li>
                        </ul>
                    </div>
                </div>
                <div className="footer__contacts">
                    <h5 className="footer__contacts_title">Контакты</h5>
                    <ul className="footer__contacts_list">
                        <li className="footer__contacts_list_item"><a href="tel:+75555555555" className="footer__contacts_link">+7 555 555-55-55</a></li>
                        <li className="footer__contacts_list_item"><a href="#" className="footer__contacts_link"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="#" className="footer__contacts_link"><svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
